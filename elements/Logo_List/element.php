...
class LogoList extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 1200, 'step' => 1]],
        true,
        false,
        [],
      ), c(
        ...
        "Type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'animated', 'text' => 'Animated'], ['text' => 'Side Scroll', 'value' => 'side-scroll'], ['text' => 'Show All', 'value' => 'show-all']]],
        false,
        false,
        [],
      ), c(
        ...
        "Vertical Gap",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 1], 'condition' => ['path' => 'design.list.type', 'operand' => 'equals', 'value' => 'show-all']],
        true,
        false,
        [],
      ), c(
        ...
        "Alignment",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'flex-start', 'text' => 'Left', 'icon' => 'AlignLeftIcon'], ['text' => 'Center', 'value' => 'center', 'icon' => 'AlignCenterIcon'], ['text' => 'Right', 'value' => 'flex-end', 'icon' => 'AlignRightIcon']], 'condition' => ['path' => 'design.list.type', 'operand' => 'equals', 'value' => 'show-all']],
        false,
        false,
        [],
      ), c(
        ...
        "Direction",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'to-left', 'text' => 'To Left', 'icon' => 'ArrowLeftIcon'], ['value' => 'to-right', 'text' => 'To Right', 'icon' => 'ArrowRightIcon']]],
        false,
        false,
        [],
      ), c(
        ...
        "Animation Type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['text' => 'Infinite', 'label' => 'Label', 'value' => 'infinite'], ['text' => 'Start on Hover', 'value' => 'start-on-hover'], ['text' => 'Stop on Hover', 'value' => 'stop-on-hover'], ['text' => 'Smooth Stop on Hover', 'value' => 'smooth-stop-on-hover']]],
        false,
        false,
        [],
      ), c(
        ...
        "Animation Duration",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['s'], 'defaultType' => 's'], 'rangeOptions' => ['min' => 10, 'max' => 50, 'step' => 1]],
        false,
        false,
        [],
      )],
        ...
        "Type",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['text' => 'Left', 'label' => 'Label', 'value' => 'left'], ['text' => 'Both', 'value' => 'both'], ['text' => 'Right', 'label' => 'Label', 'value' => 'right']]],
        false,
        false,
        [],
      ), c(
        ...
        "Color",
        [],
        ['type' => 'color', 'layout' => 'inline', 'condition' => ['path' => 'design.list.gradient_overlay.type', 'operand' => 'is one of', 'value' => ['left', 'both', 'right']]],
        false,
        false,
        [],
      ), c(
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'condition' => ['path' => 'design.list.gradient_overlay.type', 'operand' => 'is set', 'value' => ['left', 'both', 'right']], 'unitOptions' => ['types' => ['px', 'em', 'rem', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 1]],
        true,
        false,
        [],
      )],
        ['type' => 'section', 'layout' => 'inline', 'sectionOptions' => ['type' => 'popout'], 'condition' => ['path' => 'design.list.type', 'operand' => 'is one of', 'value' => ['side-scroll', 'animated']]],
        false,
        false,
        [],
      )],
        ...
        "Height",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 150, 'step' => 1]],
        true,
        false,
        [],
      ), c(
        ...
        "Max Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 60, 'max' => 200, 'step' => 10]],
        true,
        false,
        [],
      ), c(
        ...
        "Monochrome Opacity",
        [],
        ['type' => 'number', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 1, 'step' => 0.1], 'unitOptions' => ['types' => ['auto'], 'defaultType' => 'auto'], 'condition' => [[['path' => 'design.logo.monochrome_logos', 'operand' => 'is set', 'value' => '']]]],
        false,
        true,
        [],
      ), c(
        ...
        "Transition Duration",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['s']], 'rangeOptions' => ['min' => 0, 'max' => 2, 'step' => 0.1], 'condition' => [[['path' => 'design.logo.monochrome_logos', 'operand' => 'is set', 'value' => '']]]],
        false,
        false,
        [],
      )],
    ...
    {
        return [['accepts' => 'gallery', 'path' => 'content.setting.logos'], ['accepts' => 'image_url', 'path' => 'content.setting.logos[].image'], ['accepts' => 'string', 'path' => 'design.logo.content.text'], ['accepts' => 'string', 'path' => 'design.logo.content.link.url'], ['accepts' => 'image_url', 'path' => 'design.logo.background.layers[].image']];
    }
...
{% endif %}'], ['name' => 'un-static-image-grid', 'template' => '{% if design.list.type == \'show-all\' or design.list.type is null %} 
	yes
{% endif %}'], ['name' => 'monochrome-logos', 'template' => '{% if design.logo.monochrome_logos %}
	toggle is on
{% endif %}']];
    }
